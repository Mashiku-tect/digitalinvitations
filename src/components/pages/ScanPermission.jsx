      ...
      <Layout>
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
          <div className="text-center">
            <h2 className="text-xl font-bold text-gray-800 mb-3">Event Not Found</h2>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-4 px-3 md:px-6">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            ...
            <div className="sm:w-20"></div> {/* Spacer for balance */}
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-4 mb-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
              ...
              <span className={`px-2 py-1 rounded-full text-xs font-semibold ${event.active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg shadow p-4">
              <h3 className="text-lg font-bold text-gray-800 mb-3">Current Scanners</h3>
              ...
              {scanners.length > 0 ? (
                <div className="space-y-2">
                  {scanners.map((scanner) => (
                    <div key={scanner.id} className="p-3 bg-gray-50 rounded border border-gray-200">
                      <div className="flex flex-col xs:flex-row xs:justify-between xs:items-center gap-2">
                        <div className="flex items-center space-x-2 min-w-0 flex-1">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-xs text-gray-600 truncate">{scanner.tenant?.email}</p>
                          </div>
                        </div>
                        <div className="flex-shrink-0">
                          <button
                            ...
                            disabled={updating}
                            className="bg-red-100 text-red-700 hover:bg-red-200 px-2 py-1.5 rounded text-xs font-medium transition duration-300 disabled:opacity-50 flex items-center w-full xs:w-auto justify-center"
                          >
                ...
                <div className="text-center py-6">
                  ...
                  <p className="text-gray-500 text-sm">No scanners assigned yet.</p>
                  <p className="text-gray-400 text-xs mt-1">Add users from the list on the right</p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-4">
              <h3 className="text-lg font-bold text-gray-800 mb-3">Add Scanners</h3>
              <p className="text-gray-600 text-sm mb-3">
              ...
              <div className="mb-4">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2 pl-9 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
                  />
                          ...
                          <div className="flex-shrink-0">
                            {isScanner ? (
                              ...
                              <button
                                ...
                                disabled={updating}
                                className="bg-green-100 text-green-700 hover:bg-green-200 px-2 py-1.5 rounded text-xs font-medium transition duration-300 disabled:opacity-50 flex items-center w-full xs:w-auto justify-center"
                              >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-1" viewBox="0 0 20 20" fill="currentColor">
